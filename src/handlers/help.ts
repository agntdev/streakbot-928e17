...
const HELP =
  "Tap Check streak once a day. After 24 hours, your streak grows by a day.\n\n" +
  "You can log a relapse, see your stats, or hide your name from the community board whenever you need to.";
